...
# true is assigned, false is assigned but null, not assigned is not assigned
...
func is_null(property_name: String) -> bool:
	return __initialized && property_name in __assigned_properties && !__assigned_properties[property_name]

# Set a property value to null
func set_null(property_name: String) -> void:
	__assigned_properties[property_name] = false
...
pub mod tests {
    ...
    fn render_init_nullable() {
        ...
        assert_eq!(
            ...
            indent(formatdoc! {"
                if !__partial_deep || \"propName\" in src:
                {ws}__assigned_properties.prop_name = src.propName != null\n\
